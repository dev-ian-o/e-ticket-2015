...
<body class="container">
	...
	<button class="btn btn-primary">ticket size</button>
	<button class="btn btn-primary">id size</button>
	...
	<div >
			...
			<div>
			<label>Width(px):</label><input type="text" class="v-width" >
			<label>Height(px):</label><input type="text" class="v-height" >
			</div>
	</div>
</body>
